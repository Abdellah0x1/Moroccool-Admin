...
import type { AccomodationRow } from "@/components/AccomodationTable"
...
export function EditAccomodationForm({ accomodation, cities }: { accomodation: AccomodationRow; cities: City[] }) {
    const [state, formAction, isPending] = useActionState(updateAccomodation, {
        error: "",
        success: "",
    })
    return <form action={formAction} className="space-y-6 max-w-7xl mx-auto">
        {/* Header */}
        ...
        <div className="space-y-1">
            ...
            <h1 className="font-bold text-xl">Update Accommodation</h1>
            <p className="text-muted-foreground">Update hotel or riad listing for the destination guide.</p>
        </div>
        ...
        <section className="admin-card p-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input id="name" name="name" placeholder="e.g, Riad Marrakech" defaultValue={accomodation.name} />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="city_id">City</Label>
                    <Select name="city_id" defaultValue={String(accomodation.city)}>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        step="0.1"
                        placeholder="e.g, 4.5"
                        defaultValue={accomodation.rating}
                    />
                </div>
            </div>
        </section>
        ...
        <section className="admin-card p-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input id="address" name="address" placeholder="Full street address" defaultValue={accomodation.address} />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="phone">Phone</Label>
                    <Input id="phone" name="phone" placeholder="+212 6 12 34 56 78" defaultValue={accomodation.phone || ''} />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="website">Website</Label>
                    <Input id="website" name="website" placeholder="e.g, https://www.riad.com" defaultValue={accomodation.website || ''} />
                </div>
            </div>
        </section>
